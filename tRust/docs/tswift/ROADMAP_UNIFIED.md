...
### Phase 2: Apple Platforms
**Goal:** tSwift verification for iOS/macOS

| Task | Effort | Dependencies |
|------|--------|--------------|
| Fork Swift compiler | 1 commit | None |
| Implement @requires/@ensures macros | 3 commits | Swift 5.9 |
| SIL analysis pass | 5 commits | SIL understanding |
| swift-bridge to VC IR | 3 commits | vc_ir crate |
| SwiftUI verification | 5 commits | Basic verification |
| FFI boundary verification | 3 commits | Both working |
...
2. **Clone Swift compiler** - Start tSwift
...
| **iOS** | Swift | tSwift | SwiftUI/UIKit | swift-bridge | Planned |
| **macOS** | Swift | tSwift | SwiftUI/AppKit | swift-bridge | Planned |
